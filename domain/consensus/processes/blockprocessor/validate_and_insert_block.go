...
import (
	...
	"github.com/sedraxnet/sedraxd/domain/consensus/utils/multiset"
	...
	"github.com/sedraxnet/sedraxd/util/difficulty"
...
func (bp *blockProcessor) loadUTXODataForGenesis(stagingArea *model.StagingArea, block *externalapi.DomainBlock) {
	...
	// found here for anyone to verify: https://github.com/sedraxnet/sedraxd/blob/dbf18d8052f000ba0079be9e79b2d6f5a98b74ca/domain/consensus/processes/blockprocessor/resources/utxos.gz
