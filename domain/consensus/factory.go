...
import (
	...
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/blockwindowheapslicestore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/daawindowstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/mergedepthrootstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/model"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/blockparentbuilder"
	parentssanager "github.com/sedraxnet/sedraxd/domain/consensus/processes/parentsmanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/pruningproofmanager"
	"github.com/sedraxnet/sedraxd/util/staging"
	"github.com/pkg/errors"

	"github.com/sedraxnet/sedraxd/domain/prefixmanager/prefix"
	"github.com/sedraxnet/sedraxd/util/txmass"

	consensusdatabase "github.com/sedraxnet/sedraxd/domain/consensus/database"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/acceptancedatastore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/blockheaderstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/blockrelationstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/blockstatusstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/blockstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/consensusstatestore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/daablocksstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/finalitystore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/ghostdagdatastore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/headersselectedchainstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/headersselectedtipstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/multisetstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/pruningstore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/reachabilitydatastore"
	"github.com/sedraxnet/sedraxd/domain/consensus/datastructures/utxodiffstore"
	...
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/blockbuilder"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/blockprocessor"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/blockvalidator"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/coinbasemanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/consensusstatemanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/dagtopologymanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/dagtraversalmanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/difficultymanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/finalitymanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/ghostdagmanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/headersselectedtipmanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/mergedepthmanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/pastmediantimemanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/pruningmanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/reachabilitymanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/syncmanager"
	"github.com/sedraxnet/sedraxd/domain/consensus/processes/transactionvalidator"
